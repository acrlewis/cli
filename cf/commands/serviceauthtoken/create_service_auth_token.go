...
func (cmd *CreateServiceAuthTokenFields) MetaData() command_registry.CommandMetadata {
	return command_registry.CommandMetadata{
		...
		Description: i18n.T("Create a service auth token"),
		Usage:       i18n.T("CF_NAME create-service-auth-token LABEL PROVIDER TOKEN"),
	}
}
...
func (cmd *CreateServiceAuthTokenFields) Execute(c flags.FlagContext) {
	cmd.ui.Say(i18n.T("Creating service auth token as {{.CurrentUser}}...",
