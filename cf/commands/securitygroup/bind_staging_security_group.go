...
func (cmd *bindToStagingGroup) MetaData() command_registry.CommandMetadata {
	return command_registry.CommandMetadata{
		...
		Description: i18n.T("Bind a security group to the list of security groups to be used for staging applications"),
		Usage:       i18n.T("CF_NAME bind-staging-security-group SECURITY_GROUP"),
	}
}
...
func (cmd *bindToStagingGroup) Execute(context flags.FlagContext) {
	...
	cmd.ui.Say(i18n.T("Binding security group {{.security_group}} to staging as {{.username}}",
