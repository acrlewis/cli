...
func (cmd *SetOrgRole) MetaData() command_registry.CommandMetadata {
	return command_registry.CommandMetadata{
		Name:        "set-org-role",
		Description: i18n.T("Assign an org role to a user"),
		Usage: i18n.T("CF_NAME set-org-role USERNAME ORG ROLE\n\n") +
			i18n.T("ROLES:\n") +
...
func (cmd *SetOrgRole) Execute(c flags.FlagContext) {
	...
	cmd.ui.Say(i18n.T("Assigning role {{.Role}} to user {{.TargetUser}} in org {{.TargetOrg}} as {{.CurrentUser}}...",
