...
func (cmd *UpdateSpaceQuota) MetaData() command_registry.CommandMetadata {
	...
	fs["disallow-paid-service-plans"] = &cliFlags.BoolFlag{Name: "disallow-paid-service-plans", Usage: i18n.T("Can not provision instances of paid service plans")}

	return command_registry.CommandMetadata{
		Name:        "update-space-quota",
		Description: i18n.T("update an existing space quota"),
		Usage:       i18n.T("CF_NAME update-space-quota SPACE-QUOTA-NAME [-i MAX-INSTANCE-MEMORY] [-m MEMORY] [-n NEW_NAME] [-r ROUTES] [-s SERVICES] [--allow-paid-service-plans | --disallow-paid-service-plans]"),
		Flags:       fs,
	}
}
...
func (cmd *UpdateSpaceQuota) Execute(c flags.FlagContext) {
	...
	cmd.ui.Say(i18n.T("Updating space quota {{.Quota}} as {{.Username}}...",
